...
atm_file = '../../atm_W39b_10Xsolar_Twhole_evening_TP_20deg.txt' #  atm_1100_highkzz.txt  atm_elsie_w39b_dayside_ABSwKzz.txt' # TP and Kzz (optional) file
sflux_file = '../../sflux-wasp39-frances.txt' # sflux-HD189_B2020.txt This is the flux density at the stellar surface
...
# output:
output_dir = 'output/20deg/'
plot_dir = 'plot/'
movie_dir = 'plot/movie/'
out_name =  'wasp39b_10Xsolar_evening.vul' # output file name

# ====== Setting up the elemental abundance ======
# If True: using the default solar abundance from Table 8. (K.Lodders 2019)
...
fastchem_met_scale = 1e-10 # scaling factor for other elements in fastchem (e.g., if fastchem_met_scale = 0.1, other elements such as Si and Mg will take 0.1 solar values)
...
#  gravity = 4.3 m s-2, radius = 9.08e7 m
use_photo = True
# astronomy input
r_star = 0.932 # based on GAIA DR3 from Keivan Stassun stellar radius in solar radius  
Rp = 1.279 *7.1492E9 # 1.138*7.1492E9 # Planetary radius (cm) (for computing gravity)
orbit_radius = 0.04828 # planet-star distance in A.U.
sl_angle = 83 /180.*3.14159 # the zenith angle of the star in degree (usually 58 deg for the dayside average)
...
Kzz_prof = 'Pfunc' # Options: 'const','file' or 'Pfunc' (Kzz increased with P^-0.5)

K_max = 5e7        # for Kzz_prof = 'Pfunc'
K_p_lev = 5    # for Kzz_prof = 'Pfunc'

vz_prof = 'const'  # Options: 'const' or 'file'
gs = 426.         # surface gravity (cm/s^2)  (HD189:2140  HD209:936)
...
const_Kzz = 0 # (cm^2/s) Only reads when use_Kzz = True and Kzz_prof = 'const'
...
plot_spec = ['H2O', 'H', 'CH4', 'CO', 'CO2', 'C2H2', 'H2S', 'S', 'S2', 'SO','SO2']
# output:
